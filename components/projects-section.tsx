  ...
  const projects: Project[] = [
    {
      ...
      image: '/Khaled_portfolio/project-heat-exchanger.png',
    ...
    },
    {
      ...
      image: '/Khaled_portfolio/project-cooling.png',
    ...
    },
    {
      ...
      image: '/Khaled_portfolio/project-motor.png',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-12">
          {projects.map((project, idx) => (
            <div
              key={project.id}
              className="group bg-card rounded-xl overflow-hidden border border-border shadow-sm hover:shadow-lg transition-all duration-500"
            >
