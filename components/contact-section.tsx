        ...
        <div className="bg-gradient-to-br from-primary to-secondary/50 rounded-2xl p-12 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="px-8 py-3 bg-card text-primary rounded-lg font-semibold hover:bg-card/90 transition-colors"
            >
              Send Email
            </button>
            <button
            onClick={() => {
              ...
              className="px-8 py-3 bg-card/20 border border-white rounded-lg font-semibold hover:bg-card/30 transition-colors"
            >
              My LinkedIn
            </button>
          </div>
